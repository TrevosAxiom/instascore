...
use InstaScore\Platform\REST\MatchChatController;
...
use InstaScore\Platform\REST\StreamAnalyticsController;
...
final class Bootstrap {
	...
	public function register_rest_routes(): void {
		...
		( new FixtureStreamController() )->register();
		( new YouTubeStreamingController() )->register();
		( new StreamAnalyticsController() )->register();
		( new MatchChatController() )->register();
