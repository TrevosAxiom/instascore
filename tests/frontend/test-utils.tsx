...
export const testApi: ApiClient = {
  ...
  getFootballProviderHealth: () =>
    Promise.resolve({
      ...
      dataQuality: {
        status: 'healthy',
        snapshots: {
          live: { itemCount: 0, lastKnownAt: null, ageSeconds: null, stale: true },
          upcoming: { itemCount: 0, lastKnownAt: null, ageSeconds: null, stale: true },
          previous: { itemCount: 0, lastKnownAt: null, ageSeconds: null, stale: true },
        },
        incompleteMatches: 0,
        duplicateProviderIds: 0,
        unknownStatuses: [],
        canonicalMatches: { total: 0, lastSeenAt: null, completed: 0, live: 0, scheduled: 0 },
        issues: [],
      },
      conflicts: [],
      recentSyncLogs: [],
  ...
  getCommerceCatalogue: () => Promise.resolve([]),
  checkoutCommerce: () => Promise.resolve({ uuid: 'order-1', orderNumber: 'IS-001', status: 'pending', totalMinor: 500000, currency: 'NGN', paymentMethod: 'manual', paymentReference: null, createdAt: '2026-09-20 12:00:00', paidAt: null, items: [] }),
  getMyCommerceOrders: () => Promise.resolve([]),
  getMyEntitlements: () => Promise.resolve([]),
  getCommerceAdmin: () => Promise.resolve({ products: [], orders: [], report: { grossRevenueMinor: 0, paidOrders: 0, pendingOrders: 0, activeProducts: 0 } }),
  createCommerceProduct: () => Promise.resolve({ uuid: 'product-1', productType: 'ticket', name: 'Match ticket', slug: 'match-ticket', description: '', imageUrl: '', priceMinor: 500000, currency: 'NGN', stockQuantity: 100, fixtureId: null, billingPeriod: null, status: 'active' }),
  updateCommerceProduct: (_uuid, input) => Promise.resolve({ uuid: 'product-1', productType: 'ticket', name: String(input.name ?? 'Match ticket'), slug: 'match-ticket', description: '', imageUrl: '', priceMinor: 500000, currency: 'NGN', stockQuantity: 100, fixtureId: null, billingPeriod: null, status: 'active' }),
  settleCommerceOrder: () => Promise.resolve({ uuid: 'order-1', orderNumber: 'IS-001', status: 'paid', totalMinor: 500000, currency: 'NGN', paymentMethod: 'manual', paymentReference: 'manual', createdAt: '2026-09-20 12:00:00', paidAt: '2026-09-20 12:05:00', items: [] }),
  fulfilCommerceOrder: () => Promise.resolve({ uuid: 'order-1', orderNumber: 'IS-001', status: 'fulfilled', totalMinor: 500000, currency: 'NGN', paymentMethod: 'manual', paymentReference: 'manual', createdAt: '2026-09-20 12:00:00', paidAt: '2026-09-20 12:05:00', items: [] }),
  redeemCommerceTicket: (accessCode) => Promise.resolve({ status: 'redeemed', accessCode, redeemedAt: '2026-09-20 12:10:00' }),
};
