...
export const testApi: ApiClient = {
  ...
  getFantasyChat: () => Promise.resolve({ messages: [], banned: false }),
  postFantasyChat: () => Promise.reject(new Error('Not configured')),
  ...
  getCommerceAdmin: () =>
    Promise.resolve({
      products: [],
      orders: [],
      report: { grossRevenueMinor: 0, paidOrders: 0, pendingOrders: 0, activeProducts: 0 },
    }),
  ...
  updateCommerceProduct: (_uuid, input) =>
    Promise.resolve({
      uuid: 'product-1',
      productType: 'ticket',
      name: typeof input.name === 'string' ? input.name : 'Match ticket',
      slug: 'match-ticket',
      description: '',
      imageUrl: '',
      priceMinor: 500000,
  ...
  redeemCommerceTicket: (accessCode) =>
    Promise.resolve({ status: 'redeemed', accessCode, redeemedAt: '2026-09-20 12:10:00' }),
};
